 ...
 * top of the Active profile. Minimal, low-jargon: each row says what the
 * number is and how to actually train with it. The lab term is kept small
 * after the everyday name so people can connect it to the cards below. */
function profileGuideHtml(sport) {
